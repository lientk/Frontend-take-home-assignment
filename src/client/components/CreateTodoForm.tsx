...
export const CreateTodoForm = () => {
  ...
  const handleSubmitTodo = (e: React.SyntheticEvent) => {
    createTodo({
      body: todoBody,
    })
    setTodoBody('')
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="rounded-full bg-gray-700 px-5 py-2 font-sans text-sm font-bold text-white hover:bg-gray-800 focus:outline-none"
      >
        Add
      </button>
    </form>
